      ...
      <footer className="fixed-footer mt-12 border-t border-gray-200 bg-white py-4 shadow shadow-lg">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between space-x-4">
            ...
            <div className="text-s w-1/2 text-center font-semibold">
              {" "}
              <a>
                Stay up-to-date on the latest Intune related news from industry
                experts and Microsoft, with AI generated summaries and more.
              </a>
            </div>
            <div className="flex items-center space-x-4">
              <a
